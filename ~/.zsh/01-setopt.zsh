...
setopt pushd_to_home # if not args passed, pushd to home

# ===== Expansion and Globbing
setopt ksh_glob # the interpretation of parentheses is affected by a preceding `@', `*', `+', `?' or `!'
...
setopt hashdirs # automatically find new executables in the $PATH
