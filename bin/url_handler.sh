...
#   Slightly modified by Moez Bouhlel <bmoez.j@gmail.com>
...
https_prgs="${BROWSER}:XW /usr/bin/firefox:XW /usr/bin/elinks:VT"
http_prgs="${BROWSER}:XW /usr/bin/firefox:XW /usr/bin/elinks:VT"
